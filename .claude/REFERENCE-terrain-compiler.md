...
Lives in `superorganism/dashboard/prototypes/`. **COMPLETE — all 12 layers built nationally: 6,414 campgrounds across 50 states, 623 fives.** Plus a **Vehicle Trails** route overlay — **948 routes** across four tiers (scenic byways, book drives, dirt routes) as road-following lines (§13) — a **Unique Stays** lodging layer — **884 bookable one-of-a-kind places** as points (§14) — and the **human-powered Trails family** — **92 hiking journeys** (lines) + **37 day-hikes** (activity points) + a zoom-gated Waymarked "every trail" substrate (§15). The atlas resolves into four tiers: **regions · routes · points · environments**.
...
**Standings:** **92 hiking journeys** (51 exact OSM/cycling geometry + 41 authored corridors) **+ 37 day-hikes**, joining 6,414 campgrounds + 948 vehicle routes + 884 stays. The atlas now resolves into **four ontological tiers — regions (ecoregions) · routes (drives + journeys) · points (camps, stays, day-hikes) · environments (the zoom-in substrate)**. Next modes: **bike + paddle journeys** (same pipeline; Waymarked cycling/MTB + the National Water Trails system).
