...
**Standings:** **775 designated byways** (151 federal + 624 state, exact FHWA geometry) **+ 74 Book Drives** (OSRM-routed) = **849 routes**, all scored & described, **0 provisional**, rendering alongside the 6,414 camps. Byway spread **82/247/305/141** (5/4/3/2); book-drive spread **28/27/18/1**. **Next:** the **dirt sub-modes** — BDRs, forest-road loops, alpine passes, 4x4/OHV (published-GPX ingest).
